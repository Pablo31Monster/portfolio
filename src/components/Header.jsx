        ...
        <header className='w-full h-svh flex md:flex-row flex-col justify-center items-center relative' id='inicio'>
            <div className='container md:h-screen flex justify-center flex-col md:w-3/5 md:mx-8 md:order-first order-last md:px-0 px-8'>
                ...
                <div className='flex md:justify-start justify-center text-slate-400'>
                    <a className='md:mr-4 mx-3 transition duration-200 hover:text-indigo-700' target="_blank" href='https://github.com/Pablo31Monster'>
                        <Github width="45px" height="45px" style="md:w-11 w-7 md:h-11 h-7"/>
                    </a>
                    <a className='md:mr-4 mx-3 transition duration-200 hover:text-blue-500' target="_blank" href='https://www.linkedin.com/in/pablogalvezort'>
                        <Linkedin width="45px" height="45px" style="md:w-11 w-7 md:h-11 h-7"/>
                    </a>
                    <a className='md:mr-4 mx-3 transition duration-200 hover:text-red-400' target="_blank" href="/CV.pdf">
                        <Cv width="45px" height="45px" style="md:w-11 w-7 md:h-11 h-7"/>
                    </a>
                </div>
            </div>
